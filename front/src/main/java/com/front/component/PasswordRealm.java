...
//        //设置角色， 权限
//        info.setRoles(((SysUser)principalCollection.getPrimaryPrincipal()).getRoles());
//        info.setStringPermissions(((SysUser) principalCollection.getPrimaryPrincipal()).getPerms());
//        return info;
//    }
//

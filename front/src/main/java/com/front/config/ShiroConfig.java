...
////    }
//    @Bean("myRealm")
//    CasAuthenticationRealm myRealm(@Qualifier("shiroRedisManager")ShiroRedisManager shiroRedisManager,
//                          @Qualifier("hashedCredentialsMatcher")HashedCredentialsMatcher matcher) {
//
//        CasAuthenticationRealm realm = new CasAuthenticationRealm();
//        realm.setCachingEnabled(true);
//        realm.setCacheManager(shiroRedisManager);
//        realm.setAuthorizationCachingEnabled(true);
//        realm.setAuthenticationCachingEnabled(true);
...
//                                                  @Qualifier("casFilter") Cas10TicketValidationFilter casFilter){
...
//    }
//
//    private static String casUrl = "http://127.0.0.1:8443/cas";
//
//    @Bean("casFilter")
//    Cas10TicketValidationFilter filter(){
//        Cas10TicketValidationFilter casFilter = new Cas10TicketValidationFilter();
//        casFilter.setRedirectAfterValidation(true);
//        casFilter.setTicketValidator(new Cas10TicketValidator(casUrl));
//        return casFilter;
//    }
//
...
//    DefaultWebSecurityManager webSecurityManager(@Qualifier("myRealm") CasAuthenticationRealm myRealm,
